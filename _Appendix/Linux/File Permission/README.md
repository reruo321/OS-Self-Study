...
The 1st permission **r** is *read*, the 2nd **w** is *write*, and the 3rd **x** is *execute*. Omitted alphabet means no permission to do it. For instance, *r-x* means a user has **r**ead and e**x**ecute permission, but no **w**rite one.
